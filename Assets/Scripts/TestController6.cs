...
public class TestController6 : MonoBehaviour
{
    ...
    private string[] questions = { "Які з напрямків формують сутність філософії Нового часу?" };
    private string[][] answers = {
        new string[] { "Пантеїзм", "Скептицизм", "Раціоналізм", "Емпіризм" }
    };
