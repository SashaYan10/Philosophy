...
public class TestController : MonoBehaviour
{
    ...
    private string[] questions = { "Форми світогляду:", "Проблеми філософії:" };
    private string[][] answers = {
        new string[] { "Ціннісно-нормативний", "Теоретичний", "Філософський", "Пізнавальний", "Морально-вольовий", "Практичний" },
        new string[] { "Що складає сутність природи і Всесвіту?", "Проблема географізму", "Що таке людина та її місце у світі?", "Що таке світ?", "Природа свободи волі", "В якому відношенні знаходиться розум та зовнішній світ?" }
    };

    // Список списків правильних відповідей для кожного питання.
    private List<List<int>> correctAnswersList = new List<List<int>> {
        new List<int> { 0, 3, 4 }, // Правильні відповіді для першого питання: індекси 0 та 1.
        new List<int> { 0, 2, 5 }
    };
