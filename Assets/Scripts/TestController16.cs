...
public class TestController16 : MonoBehaviour
{
    ...
    private string[] questions = { "Поняття «цінність» формується на основі:" };
    private string[][] answers = {
        new string[] { "суспільної практики", "індивідуальної діяльності людини", "певних конкретно-історичних, суспільних відносин", "форм спілкування людей" }
    };
