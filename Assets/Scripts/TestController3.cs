...
public class TestController3 : MonoBehaviour
{
    ...
    private string[] questions = { "Які основні принципи філософії Епікура?" };
    private string[][] answers = {
        new string[] { "ніщо не виникає з небуття", "ніщо не зникає в небуття", "всесвіт завжди був таким, яким є тепер, і завжди буде таким", "велика математична формула, яка описує всі можливі сценарії існування та розвитку всесвіту" } 
    };
