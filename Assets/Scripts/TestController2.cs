...
public class TestController2 : MonoBehaviour
{
    ...
    private string[] questions = { "Які чотири істини знаходяться у центрі буддистського вчення?" };
    private string[][] answers = {
        new string[] { "Життя є страждання.", "Причиною страждання є бажання, яке веде через радощі та пристрасті до переродження, народження знову.", "Усунення причин страждань полягає в усуненні цього бажання.", "Шляхом, що веде до усунення страждань є правильне судження, рішення, мова, життя і т.д." }
    };
