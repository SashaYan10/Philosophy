...
public class TestController5 : MonoBehaviour
{
    ...
    private string[] questions = { "Чи усі перераховані особливості відносяться до світогляду гуманістів?" };
    private string[][] answers = {
        new string[] { "критика догматизму", "доказ права людини на пошук істини", "відстоювання ідеалів утилітаризму", "пропаганда любові та доброти як основи людських відношень" }
    };
