...
public class TestController9 : MonoBehaviour
{
    ...
    private string[] questions = { "Які з перерахованих проблем є основними для онтології?", "Які основні концепції були сформовані філософами періода Нового часу?" };
    private string[][] answers = {
        new string[] { "Як виник світ?", "Яка будова світу?", "Який характер відношень між расами світу?", "Як розвивалися цивілізації?" },
        new string[] { "Теїзм", "Пантеїзм", "Деїзм", "Екзистенціоналізм" }
    };
